...
@section('page_title', 'Edit Jasa')
@section('page_description', 'Form untuk memperbarui data jasa/layanan.')
...
@section('content')
    ...
    <form action="{{ route('jasa.update', $jasa) }}" method="POST">
        @csrf
        @method('PUT')
            ...
            <div class="col-lg-8">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nama_jasa') is-invalid @enderror" id="nama_jasa"
                        name="nama_jasa" value="{{ old('nama_jasa', $jasa->nama_jasa) }}" placeholder="Misal: Pembuatan Website Company Profile" required>
                    @error('nama_jasa')
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('harga') is-invalid @enderror" id="harga"
                        name="harga" value="{{ old('harga', $jasa->harga) }}" min="0" placeholder="Misal: 2000000" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('lama_pekerjaan') is-invalid @enderror" id="lama_pekerjaan"
                        name="lama_pekerjaan" value="{{ old('lama_pekerjaan', $jasa->lama_pekerjaan) }}" placeholder="Misal: 2 minggu" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('yang_didapat') is-invalid @enderror" id="yang_didapat" name="yang_didapat"
                        rows="5" placeholder="Tuliskan satu item per baris" required>{{ old('yang_didapat', $jasa->yang_didapat) }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan"
                        rows="3" placeholder="Deskripsi tambahan (opsional)">{{ old('keterangan', $jasa->keterangan) }}</textarea>
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check"></i> Perbarui Jasa
                    </button>
